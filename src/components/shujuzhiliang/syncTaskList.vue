    ...
    <row>
      <i-col span="21">
        <Breadcrumb class="ml32">
          <Breadcrumb-item class="black">数据同步</Breadcrumb-item>
          <!-- <Breadcrumb-item class="blue">数据同步</Breadcrumb-item> -->
        </Breadcrumb>
        <Collapse class="aa">
          <Panel name="1">
            条件筛选
            <template slot="content">
              <Form ref="formInline" :model="formInline" inline :label-width="80">
                ...
                <Form-item label="执行时间" prop="lastrundt">
                  <Date-picker type="datetime" placeholder="选择日期和时间"  format="yyyy-MM-dd HH:mm"></Date-picker>
                </Form-item>
  ...
  export default {
    ...
    methods: {
      submitSearch: function(page) {
        ...
        params.data.searchValue.tasktype = "同步";
