    ...
    <row>
      <i-col span="21">
        <Breadcrumb class="ml32">
          ...
          <Breadcrumb-item class="blue">月雨量统计</Breadcrumb-item>
        </Breadcrumb>
...
<script>
  export default {
    data () {
      return {
        collectionLogListUrl: 'gmmeteo/datacenter/history/monthrain',
    ...
    methods: {
      ...
      exportExcel: function() {
        if (this.formInline.year != '') {
          window.open(parameters.domain + 'gmmeteo/datacenter/export/monthRain?station_name=' + this.formInline.station_name +
