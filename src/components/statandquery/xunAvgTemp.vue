...
<script>
  export default {
    data () {
      return {
        collectionLogListUrl: 'gmmeteo/datacenter/history/xunavgtemp',
    ...
    methods: {
      ...
      exportExcel: function() {
        if (this.formInline.year != '' && this.formInline.month != '') {
          window.open(parameters.domain + 'gmmeteo/datacenter/export/xunAvgTemp?station_name=' + this.formInline.station_name +
