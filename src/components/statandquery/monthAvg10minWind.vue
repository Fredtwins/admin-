    ...
    <row>
      <i-col span="21">
        <Breadcrumb class="ml32">
          ...
          <Breadcrumb-item class="blue">月平均10分钟风速统计</Breadcrumb-item>
        </Breadcrumb>
...
<script>
  export default {
    data () {
      return {
        collectionLogListUrl: 'gmmeteo/datacenter/history/monthavg10minwind',
    ...
    methods: {
      ...
      exportExcel: function() {
        if (this.formInline.year != '') {
          window.open(parameters.domain + 'gmmeteo/datacenter/export/monthAvg10minWind?station_name=' + this.formInline.station_name +
