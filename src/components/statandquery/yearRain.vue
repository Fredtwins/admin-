    ...
    <row>
      <i-col span="21">
        <Breadcrumb class="ml32">
          ...
          <Breadcrumb-item class="blue">年雨量统计</Breadcrumb-item>
        </Breadcrumb>
...
<script>
  export default {
    data () {
      return {
        collectionLogListUrl: 'gmmeteo/datacenter/history/yearrain',
    ...
    methods: {
      ...
      exportExcel: function() {
        window.open(parameters.domain + 'gmmeteo/datacenter/export/yearRain?station_name=' + this.formInline.station_name +
