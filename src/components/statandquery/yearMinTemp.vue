    ...
    <row>
      <i-col span="21">
        <Breadcrumb class="ml32">
          ...
          <Breadcrumb-item class="blue">年最低日温度统计</Breadcrumb-item>
        </Breadcrumb>
...
<script>
  export default {
    data () {
      return {
        collectionLogListUrl: 'gmmeteo/datacenter/history/yearmintemp',
    ...
    methods: {
      ...
      exportExcel: function() {
        window.open(parameters.domain + 'gmmeteo/datacenter/export/yearMinTemp?station_name=' + this.formInline.station_name +
