    ...
    <row>
      <i-col span="21">
        <Breadcrumb class="ml32">
          ...
          <Breadcrumb-item class="blue">年最高日温度统计</Breadcrumb-item>
        </Breadcrumb>
...
<script>
  export default {
    data () {
      return {
        collectionLogListUrl: 'gmmeteo/datacenter/history/yearmaxtemp',
    ...
    methods: {
      ...
      exportExcel: function() {
        window.open(parameters.domain + 'gmmeteo/datacenter/export/yearMaxTemp?station_name=' + this.formInline.station_name +
