    ...
    <row>
      <i-col span="21">
        <Breadcrumb class="ml32">
          ...
          <Breadcrumb-item class="blue">年最大10分钟风速统计</Breadcrumb-item>
        </Breadcrumb>
...
<script>
  export default {
    data () {
      return {
        collectionLogListUrl: 'gmmeteo/datacenter/history/yearmax10minwind',
    ...
    methods: {
      ...
      exportExcel: function() {
        window.open(parameters.domain + 'gmmeteo/datacenter/export/yearMax10minWind?station_name=' + this.formInline.station_name +
